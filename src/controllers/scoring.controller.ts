...
class ScoringController {
  ...
  public getHistory = async (
	...
	public scoreForm = async (
		...
		try {
			const data:any[] = await this.service.scoreForm(_req.params.id,{..._req.query,user:_req['user']});
  ...
  public rescore = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
	try {
		let param = {...req.body}
...
public rescoreAll = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
	try {
		let param = {...req.body}
