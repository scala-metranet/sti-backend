...
import SprintMasterService from "@/services/sprint_master.service";

class SprintMasterController {
	public service = new SprintMasterService();
	...
	public get = async (
      ...
      const page = _req.query.page ? _req.query.page : 1;
			const perPage = _req.query.perPage ? _req.query.perPage : 9999;
...
export default SprintMasterController;
