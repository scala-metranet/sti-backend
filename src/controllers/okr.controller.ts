...
class OkrController {
	...
	public create = async (
		...
		try {
			...
			const data:Sprint = await this.service.create({...param,mentor_id:req['user'].id});
	...
	public createSprintKr = async (
		...
		try {
			const param:any = req.body;
			const data:Sprint = await this.service.createSprintKr({...param,user_id:req['user'].id});
	...
	public updateSprint = async (
		...
		try {
			const param:any = req.body;
			const data:Sprint = await this.service.updateSprint({...param,id:req.params.id,user_id:req['user'].id});
	...
	public createTask = async (
		...
		try {
			const param:any = req.body;
			const data:OkrTask[] = await this.service.createTask({...param,mentee_id:req['user'].id});
	...
	public updateTask = async (
		...
		try {
			const param:any = req.body;
			const data:OkrTask = await this.service.updateTask({...param,user_id:req['user'].id});
	...
	public uploadTask = async (
		...
		try {
			...
			const data:any = await this.service.updateResult({...param,mentee_id:req['user'].id});
